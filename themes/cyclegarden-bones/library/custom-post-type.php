...
function module_post_type() { 
	...
	register_post_type( 'module', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'edit_item' => __( 'Edit Modules', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'New Module', 'bonestheme' ), /* New Display Title */
			'view_item' => __( 'View Module', 'bonestheme' ), /* View Display Title */
			'search_items' => __( 'Search Module', 'bonestheme' ), /* Search Module Title */ 
			'not_found' =>  __( 'Nothing found in the Database.', 'bonestheme' ), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __( 'Nothing found in Trash', 'bonestheme' ), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'Custom content blocks used in various areas in the site', 'bonestheme' ), /* Module Description */
			'public' => true,
	...
	*/
	...
	register_taxonomy( 'module_cat', 
		array('module'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
		array('hierarchical' => true,     /* if this is true, it acts like categories */
			'labels' => array(
				'name' => __( 'Module Categories', 'bonestheme' ), /* name of the Module taxonomy */
				'singular_name' => __( 'Module Category', 'bonestheme' ), /* single taxonomy name */
				'search_items' =>  __( 'Search Module Categories', 'bonestheme' ), /* search title for taxomony */
				'all_items' => __( 'All Module Categories', 'bonestheme' ), /* all title for taxonomies */
				'parent_item' => __( 'Parent Module Category', 'bonestheme' ), /* parent title for taxonomy */
				'parent_item_colon' => __( 'Parent Module Category:', 'bonestheme' ), /* parent taxonomy title */
				'edit_item' => __( 'Edit Module Category', 'bonestheme' ), /* edit Module taxonomy title */
				'update_item' => __( 'Update Module Category', 'bonestheme' ), /* update title for taxonomy */
				'add_new_item' => __( 'Add New Module Category', 'bonestheme' ), /* add new title for taxonomy */
				'new_item_name' => __( 'New Module Category Name', 'bonestheme' ) /* name title for taxonomy */
			),
	...
	register_taxonomy( 'module_tag', 
		...
		array('hierarchical' => false,    /* if this is false, it acts like tags */
			'labels' => array(
				'name' => __( 'Module Tags', 'bonestheme' ), /* name of the Module taxonomy */
				'singular_name' => __( 'Module Tag', 'bonestheme' ), /* single taxonomy name */
				'search_items' =>  __( 'Search Module Tags', 'bonestheme' ), /* search title for taxomony */
				'all_items' => __( 'All Module Tags', 'bonestheme' ), /* all title for taxonomies */
				'parent_item' => __( 'Parent Module Tag', 'bonestheme' ), /* parent title for taxonomy */
				'parent_item_colon' => __( 'Parent Module Tag:', 'bonestheme' ), /* parent taxonomy title */
				'edit_item' => __( 'Edit Module Tag', 'bonestheme' ), /* edit Module taxonomy title */
				'update_item' => __( 'Update Module Tag', 'bonestheme' ), /* update title for taxonomy */
				'add_new_item' => __( 'Add New Module Tag', 'bonestheme' ), /* add new title for taxonomy */
				'new_item_name' => __( 'New Module Tag Name', 'bonestheme' ) /* name title for taxonomy */
			),
			'show_admin_column' => true,
			'show_ui' => true,
			'query_var' => true,
