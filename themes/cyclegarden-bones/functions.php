...
add_image_size( 'bones-gallery', 1600, 1000, false );
...
function bones_custom_image_sizes( $sizes ) {
    return array_merge( $sizes, array(
        ...
        'bones-gallery' => __('1600px by 1000px'),
    ) );
}
...
add_shortcode('gallery', 'cyc_gallery_shortcode');
...
function cyc_gallery_shortcode( $attr ) {
	$post = get_post();
